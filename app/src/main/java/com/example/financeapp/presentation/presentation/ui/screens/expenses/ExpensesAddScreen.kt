...
fun ExpensesAddScreen(
    ...
    MainPattern(
        ...
        actionButtonLabel = "Add Expenses",
        onActionButtonClick = {
            val newNote = ExpensesModel(
                title = title,
        ...
        onBackClicked = {
            navHostController.navigate(Screens.ExpensesScreen.route) {
